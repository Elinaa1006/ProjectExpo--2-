...
public class CSVWriterPenjadwalan {

    public void simpanData(ArrayList<Penjadwalan> dataJadwal) {
        String csvFile = "ProjectExpo\\ProjectExpo\\src\\TampilanAwal\\penjadwalan.csv";
        ...
        try (FileWriter fileWriter = new FileWriter(csvFile, true)) {
            ...
            for (Penjadwalan i : dataJadwal) {
                writer.println(i.getTanggal() + delimiter);}
